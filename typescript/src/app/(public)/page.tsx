...
const PREVIEW_ROUTES = [
  ...
  { label: "Invite (valid)", href: buildInviteRoute("discord-room") },
  { label: "Invite (invalid)", href: buildInviteRoute("invalid-code") },
  { label: "Invite (expired)", href: buildInviteRoute("expired-2026") },
