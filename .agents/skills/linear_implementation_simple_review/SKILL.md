...
## Routing Rules
1. If input is a parent issue with child issues, route to `$linear-implementation-simple-review-parent`.
2. If input is a child issue start or standalone smallest-unit issue start, route to `$linear-implementation-simple-review-leaf`.
